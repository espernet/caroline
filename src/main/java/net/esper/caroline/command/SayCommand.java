...
/**
 * The say command that makes the bot say given text to a channel or user.
 * 
...
public class SayCommand extends Command {
	...
	public SayCommand(Event event, String[] args) {
		super(event, args);
	}
	...
	public void run() {
		...
		event.getBot().sendMessage(args[1], message);
	}
